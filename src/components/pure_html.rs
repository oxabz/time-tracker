/**
Module containing all the pure HTML components.
 */
pub mod icons {
    ...
    pub fn success()-> impl IntoView {
        view! {
            <svg class="stroke-current shrink-0 h-6 w-6" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    pub fn error() -> impl IntoView{
        view! {
            <svg  class="stroke-current shrink-0 h-6 w-6" width="800px" height="800px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="none">
